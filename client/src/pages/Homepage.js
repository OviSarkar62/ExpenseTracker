...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const getAllTransactions = async () => {
      try {
        ...
        setLoading(true);
        const res = await axios.post("https://expense-tracker-n12j.onrender.com/transactions/get-transaction", {
          userid: user._id,
          frequency,
          selectedDate,
          type,
  ...
  const handleDelete = async (record) => {
    try {
      setLoading(true);
      await axios.post("https://expense-tracker-n12j.onrender.com/transactions/delete-transaction", {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      setLoading(true);
      if (editable) {
        await axios.post("https://expense-tracker-n12j.onrender.com/transactions/edit-transaction", {
          payload: {
            ...values,
            userId: user._id,
          },
        ...
        await axios.post("https://expense-tracker-n12j.onrender.com/transactions/add-transaction", {
          ...values,
          userid: user._id,
        });
        setLoading(false);
